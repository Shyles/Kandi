...
Luvussa \ref{KleinberginMalli} esitetylle pieni maailma -verkolle voidaan muodostaa ahne algoritmi, jonka keskimääräinen \textit{hyppyjen} (monellako solmulla viesti on käynyt) määrä on \( \mathcal{O} (log^2n) \). Käytämme tätä suuretta myöhemmin vertailua varten.
